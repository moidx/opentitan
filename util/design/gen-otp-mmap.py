...
# memory map source
MMAP_DEFINITION_FILE = "hw/ip/caliptra_otp_ctrl/data/otp_ctrl_mmap.hjson"
# documentation tables to generate
PARTITIONS_TABLE_FILE = "hw/ip/caliptra_otp_ctrl/doc/otp_ctrl_partitions.md"
DIGESTS_TABLE_FILE = "hw/ip/caliptra_otp_ctrl/doc/otp_ctrl_digests.md"
MMAP_TABLE_FILE = "hw/ip/caliptra_otp_ctrl/doc/otp_ctrl_mmap.md"

# code templates to render
COV_TEMPLATES = ["hw/ip/caliptra_otp_ctrl/data/otp_ctrl_cov_bind.sv.tpl"]
DATA_TEMPLATES = ["hw/ip/caliptra_otp_ctrl/data/otp_ctrl.hjson.tpl"]
DIF_TEMPLATES = [
    "hw/ip/caliptra_otp_ctrl/data/dif_otp_ctrl.c.tpl",
    "hw/ip/caliptra_otp_ctrl/data/dif_otp_ctrl.h.tpl",
    "hw/ip/caliptra_otp_ctrl/data/dif_otp_ctrl_unittest.cc.tpl"
]
ENV_TEMPLATES = [
    "hw/ip/caliptra_otp_ctrl/data/otp_ctrl_env_cov.sv.tpl",
    "hw/ip/caliptra_otp_ctrl/data/otp_ctrl_env_pkg.sv.tpl",
    "hw/ip/caliptra_otp_ctrl/data/otp_ctrl_if.sv.tpl",
    "hw/ip/caliptra_otp_ctrl/data/otp_ctrl_scoreboard.sv.tpl"
]
RTL_TEMPLATES = ["hw/ip/caliptra_otp_ctrl/data/otp_ctrl_part_pkg.sv.tpl"]
SEQ_TEMPLATES = [
    "hw/ip/caliptra_otp_ctrl/data/otp_ctrl_base_vseq.sv.tpl",
    "hw/ip/caliptra_otp_ctrl/data/otp_ctrl_dai_lock_vseq.sv.tpl",
    "hw/ip/caliptra_otp_ctrl/data/otp_ctrl_smoke_vseq.sv.tpl"
]
